...
function ASS_ShortBan ( TO_BAN, TIME, Banner, REASON, nomessage )
	...
	MySQLQuery(SiteDatabaseConnection, "INSERT INTO `bans` (`ID`, `NAME`, `UNBAN`, `BANNER`, `REASON`) VALUES ('" .. StripForHTTP(TO_BAN:SteamID()) .. "', '" .. StripForHTTP(TO_BAN:Nick()) .. "', '" .. StripForHTTP(SendTime) .. "', '" .. StripForHTTP(Banner) .. "', '" .. StripForHTTP(REASON) .. "')");
